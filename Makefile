...
# CC = $(LLVM_PREFIX)/bin/clang-13
# CXX = $(LLVM_PREFIX)/bin/clang-13++
...
uws:
	cd $(USOCKETS_DIR) && $(CXX) $(BITCODE_OR_SECTIONS) $(EMIT_LLVM_FOR_RELEASE) -fPIC -I$(BUN_DEPS_DIR)/uws/uSockets/src $(CLANG_FLAGS) $(CFLAGS) $(UWS_CXX_FLAGS) $(UWS_LDFLAGS) $(PLATFORM_LINKER_FLAGS) -c -I$(BUN_PKG_INCLUDE) $(BUN_PKG_LIB)/libusockets.a $(BUN_PKG_INCLUDE)/libuwsockets.cpp -o $(BUN_PKG_LIB)/libuwsockets.o
